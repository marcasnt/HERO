...
type Routine = { exercises?: Array<{ name: string; day?: string; sets: number; reps: string; series?: Array<{ reps: string; weight: number | null }>; rest?: number; rir?: number; notes?: string; gif?: string; target?: string; equipment?: string; steps?: string[] }> };
